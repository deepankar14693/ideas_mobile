...
export const getCurrentGroupDetails = (groupMasterData, groupId) => {
    var groupDetail = _.filter(groupMasterData, { 'GroupId': groupId });
...
export const getCachedState = () => createSelector(
    cachedState,
    (cachedState) => ({
        cachedState
    })
