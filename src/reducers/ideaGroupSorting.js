...
const updateSortingFilters = (state, action) => {
    ...
    switch (view) {
        ...
        case 15:
            switch (action.type) {
                case 'SCR_SORT_IDEAGROUP':
                    setLocalStorageKey('ideasSentButRejectedSortColumn', '');
                    setLocalStorageKey('ideasSentButRejectedSortAscending', undefined);
                    setLocalStorageKey('ideasSentButRejectedSortingOn', '');
                    setLocalStorageKey('ideasSentButRejectedScr', action.payload);
                    return update(state, {
                ...
                case 'IDEAGROUP_LIST_SORT':
                case 'SORT_OUTGOING_VIEWS':
                    setLocalStorageKey('ideasSentButRejectedSortColumn', action.payload.column);
                    setLocalStorageKey('ideasSentButRejectedSortAscending', action.payload.direction);
                    setLocalStorageKey('ideasSentButRejectedSortingOn', action.payload.sortingOn);
                    setLocalStorageKey('ideasSentButRejectedScr', false);
                    return update(state, {
                        ideasSentButRejectedView: {
                            scr: { $set: false },
                            sortColumn: { $set: action.payload.column },
