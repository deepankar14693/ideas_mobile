...
import { convertArrayToDictionary, getDecisionGo, getDecisionNoGo, getRiskSortId, isCheckBoxChecked } from '../../../common/utils';
...
export const updateIdeaGroupView = (idea, entireState) => {
    ...
    const starIdeas = entireState.starIdeas ? entireState.starIdeas : [];
